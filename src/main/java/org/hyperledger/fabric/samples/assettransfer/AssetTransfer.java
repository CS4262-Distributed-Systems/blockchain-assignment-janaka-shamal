...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * This function is used to duplicate asset & assign to new owner
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being transferred
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner){
        // assigning new id to duplicate asset
        String duplicateAssetId = "duplicate-" + assetID;
        // if asset is not exist, ReadAsset function will throw an exeption.
